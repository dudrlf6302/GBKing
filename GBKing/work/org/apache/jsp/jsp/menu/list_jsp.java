...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tfrm.action = \"/GBKing/menu/view.do\";\r\n");
      out.write("\t\tfrm.submit();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction goWrite(mode) {\r\n");
      out.write("\t\tvar frm = document.form;\r\n");
      out.write("\t\tfrm.mode.value = mode;\r\n");
      out.write("\t\tfrm.action = \"/GBKing/menu/write.do\";\r\n");
      out.write("\t\tfrm.submit();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction calc() {\r\n");
      out.write("\t\tvar price = document.getElementsByName(\"price\");\r\n");
      out.write("\t\tvar count = document.getElementsByName(\"count\");\r\n");
      out.write("\t\tvar order_menu_name = document.getElementsByName(\"order_menu_name\");\r\n");
      out.write("\t\tvar result = 0;\r\n");
      out.write("\r\n");
      out.write("\t\tfor ( var i = 0; i < price.length; i++) {\r\n");
      out.write("\t\t\tif (order_menu_name[i].checked) {\r\n");
      out.write("\t\t\t\tif (count[i].value == \"\") {\r\n");
      out.write("\t\t\t\t\tcount[i].value = 0;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tvar x = price[i].value;\r\n");
      out.write("\t\t\t\tvar y = count[i].value;\r\n");
      out.write("\t\t\t\tresult = eval(result) + (eval(x) * eval(y));\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\tvar frm = document.form;\r\n");
      out.write("\t\tfrm.action = \"/GBKing/menu/buy.do\";\r\n");
      out.write("\t\tfrm.Total_price.value = document.getElementById(\"result\").innerHTML;\r\n");
      out.write("\t\tfrm.submit();\r\n");
      out.write("\t\talert(\"구매완료 되었습니다.\")\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction getResult() {\r\n");
      out.write("\t\tdocument.getElementById(\"result_temp\").value = document\r\n");
      out.write("\t\t\t\t.getElementById(\"result\").innerHTML;\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("123\r\n");
      out.write("<body id=\"products\">\r\n");
      out.write("\t<header>\r\n");
      out.write("\t");
...
if(leftMenu.equals("write")){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"menu_mod\" value=\"");
      out.print(dto.getMenu_mod());
      out.write("\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<a class=\"m\" href=\"/GBKing/upload/");
      out.print(dto.getImage());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src=\"/GBKing/upload/");
      out.print(dto.getImage());
      out.write("\" alt=\"");
      out.print(dto.getMenu_name());
      out.write("\" width=\"200\" height=\"200\"/>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<h2 align=\"center\"><font size=2><a href=\"#none\" onclick=\"goView('");
      out.print(seq);
      out.write("')\">");
      out.print(dto.getMenu_name());
      out.write("</a>&nbsp;&nbsp; ");
      out.print(dto.getPrice());
      out.write("₩</font></h2>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<h2 align=\"center\"><font size=2>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"order_menu_name\" value=\"");
      out.print(dto.getMenu_name());
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" value=\"0\" name=\"count\" style=\"width:10px\" maxlength=\"2\" onKeyUp=\"calc()\" />&nbsp;EA\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</font></h2>\r\n");
      out.write("\t\t\t\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<td><input type=\"hidden\" name=\"Total_price\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<h2><font size=3 color=\"#54301a\">총 금액 : </font>\r\n");
      out.write("\t\t\t\t\t\t\t\t<font size=3 color=\"#cc0d1c\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div id=\"result\" value=\"0\" style='display: inline';></div> &nbsp;₩&nbsp;&nbsp; \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"button\" value=\"구매\" style=\"width: 40px\" style=\"height:30px\" onclick=\"Buy()\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</font></h2>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
